...
import com.hichinaschool.flashcards.themes.StyledOpenCollectionDialog;
...
public class DeckPicker extends FragmentActivity {
     ...
     * Context Menus
     */
    private static final int CONTEXT_MENU_COLLAPSE_DECK = 2;
    private static final int CONTEXT_MENU_RENAME_DECK = 1;
    private static final int CONTEXT_MENU_DELETE_DECK = 0;
    ...
    DeckTask.TaskListener mLoadStatisticsHandler = new DeckTask.TaskListener() {
        ...
        public void onPostExecute(DeckTask.TaskData result) {
            ...
            if (result.getBoolean()) {
                ...
                // } else {
                Intent intent = new Intent(DeckPicker.this, com.hichinaschool.flashcards.charts.ChartBuilder.class);
...
//								}
								...
								TextView txt = (TextView) ((View) view.getParent()).findViewById(R.id.deckpicker_url);
                		...
                		Button downloadButton = (Button) ((View) view.getParent()).findViewById(R.id.deckpicker_button);
...
//        hashmap.put("HiChina!", "HiChina! Lesson 1");
//        hashmap.put("HiChina!", "HiChina! Lesson 2");
//        hashmap.put("HiChina!", "HiChina! Lesson 3");
//        
//        mDeckList.add(hashmap);
//        TaskData result = new TaskData(mDeckList);
//        Object[] res = result.getObjArray();
//        TreeSet<Object[]> decks = new TreeSet<Object[]>();
//        decks.add(res);
//        
//        
//        updateDecksList(decks, 0, 3);
...
//                    dialog.show();
        ...
        if (deckId == -100 || deckId == -200 || deckId == -300 || deckId == -400 || deckId == -500) {
        	...
        	easyTracker.send(MapBuilder
        		      .createEvent(getString(R.string.ga_event_download_deck_category),
        		    		  		getString(R.string.ga_event_download_deck_action),
        		    		  		null,
        		    		  		deckId)
        		      .build());
    ...
    Connection.TaskListener mDownloadDeckListener = new Connection.TaskListener() {
        ...
        public void onPostExecute(Payload data) {
            ...
            if (data.success) {
            	mImportPath = (String) data.result;
            	if (AnkiDroidApp.colIsOpen() && mImportPath != null) {
                    DeckTask.launchDeckTask(DeckTask.TASK_TYPE_IMPORT, mImportAddListener,
                            new TaskData(AnkiDroidApp.getCol(), mImportPath, true));
                    mImportPath = null;
//                    mDeckList.remove(mDeckListView.getItemAtPosition(mDeckLastItemSelected+1));
//                    mDeckListAdapter.notifyDataSetChanged();
                }
            } else {
                StyledDialog.Builder builder = new StyledDialog.Builder(DeckPicker.this);
        ...
        public void onDisconnected() {
        	Themes.showThemedToast(
                    DeckPicker.this,
                    getResources().getString(R.string.connection_needed), true);
